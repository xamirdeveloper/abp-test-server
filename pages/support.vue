<template>
  ...
  <fixed-action-btn title="تماس با پشتیبانی" />
</template>

<script lang="ts" setup>
  const faqs = [
    {
      question: 'چطور می‌توانم حساب کاربری بسازم؟',
      answer: 'برای ساخت حساب کاربری، شماره موبایل خود را وارد کرده و کد تایید را وارد کنید.',
    },
    {
